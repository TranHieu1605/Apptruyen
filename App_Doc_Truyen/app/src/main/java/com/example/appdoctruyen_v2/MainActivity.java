...
public class MainActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        menuItems.add(new MenuItem("Home", R.drawable.lib));
        menuItems.add(new MenuItem("Đăng bài", R.drawable.them));
        menuItems.add(new MenuItem("Truyện đã yêu thích", R.drawable.fvr));
        menuItems.add(new MenuItem("Tất cả truyện", R.drawable.bk));
        menuItems.add(new MenuItem("Thông tin app", R.drawable.ttin));
        menuItems.add(new MenuItem("Đăng xuất", R.drawable.logout));
